#!/usr/bin/env python3
"""Final canonical-ID and clean-validator wrapper for T06-7-hotfix1."""
...
COST_BY_HERO_ID = {
    "shimazu_yoshihiro": 1,
    "cheok_jun_gyeong": 2, "dorim": 2, "fan_zeng": 2, "xiahou_dun": 2,
    "lu_meng": 2, "konishi_yukinaga": 2, "honda_masanobu": 2,
    "honda_tadakatsu": 2, "jebe": 2,
    "jeong_do_jeon": 3, "kwon_yul": 3, "kim_chun_chu": 3, "kim_yu_sin": 3,
    "jang_bo_go": 3, "uija_wang": 3, "gyebaek": 3, "heukchi_sangji": 3,
    "xun_yu": 3, "lu_bu": 3, "guo_jia": 3, "guan_yu": 3, "zhang_fei": 3,
    "sun_ce": 3, "nobunaga": 3, "takeda_shingen": 3, "kenshin": 3, "subutai": 3,
    "yi_sun_sin": 4, "gwanggaeto": 4, "eulji_mundeok": 4, "xiang_yu": 4,
    "cao_cao": 4, "zhuge_liang": 4, "liu_bei": 4, "zhou_yu": 4,
    "toyotomi_hideyoshi": 4, "tokugawa_ieyasu": 4, "genghis_khan": 4,
}
...
def write_clean_validator() -> None:
    (ROOT / "tools/validate_t06_t07_playable_transaction.py").write_text(VALIDATOR, encoding="utf-8")


hotfix.patch_costs = patch_costs_by_id
hotfix.patch_runtime_validator = write_clean_validator
hotfix.main()

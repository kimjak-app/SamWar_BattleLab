...
static func get_portrait_template_offset(layout_offsets_by_facing: Dictionary, fallback_offset: Vector2, facing: String, facing_left: String, facing_right: String, facing_up: String, facing_down: String) -> Vector2:
	var normalized_facing := _normalize_facing(facing, facing_left, facing_right, facing_up, facing_down)
	if layout_offsets_by_facing.has(normalized_facing):
		return layout_offsets_by_facing[normalized_facing]
	return get_facing_aware_portrait_offset(fallback_offset, normalized_facing, facing_left, facing_right, facing_up, facing_down)
...
static func get_facing_aware_portrait_offset(base_offset: Vector2, facing: String, facing_left: String, facing_right: String, facing_up: String, facing_down: String) -> Vector2:
...
static func _normalize_facing(facing: String, facing_left: String, facing_right: String, facing_up: String, facing_down: String) -> String:
	if facing == facing_left or facing == facing_right or facing == facing_up or facing == facing_down:
		return facing
	return facing_right

...
@onready var cutin_stage: Control = $CutinRoot/CutinStage
@onready var dim_overlay: ColorRect = $CutinRoot/DimOverlay
@onready var video_background_player: VideoStreamPlayer = $CutinRoot/CutinStage/VideoBackgroundPlayer
...
@onready var hero_portrait: TextureRect = $CutinRoot/CutinStage/HeroContainer/HeroPortrait
@onready var title_container: Control = $CutinRoot/CutinStage/TitleContainer
@onready var title_hero_name: Label = $CutinRoot/CutinStage/TitleContainer/HeroNameLabel
@onready var title_skill_name: Label = $CutinRoot/CutinStage/TitleContainer/SkillNameLabel
@onready var accent_line: ColorRect = $CutinRoot/CutinStage/TitleContainer/AccentLine

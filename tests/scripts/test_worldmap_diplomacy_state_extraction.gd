...
func _check_cooldown_state() -> void:
	...
	_service.call("set_diplomacy_action_cooldown", _worldmap.call("_ensure_diplomacy_controller"), first, first_turns)
	_service.call("set_diplomacy_action_cooldown", _worldmap.call("_ensure_diplomacy_controller"), second, second_turns)
	...
	_expect(int(_worldmap.call("_ensure_diplomacy_controller").call("_get_diplomacy_action_cooldown", first)) == first_turns, "cooldown wrapper reads service state")
	_service.call("set_diplomacy_action_cooldown", _worldmap.call("_ensure_diplomacy_controller"), first, -first_turns)
...
func _check_action_cooldown_and_rejection() -> void:
	...
	var first: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "tribute", city_id)
	...
	var rejected: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "envoy", city_id)
...
func _check_turn_advance_and_expiry() -> void:
	...
	_worldmap.call("_sync_diplomacy_action_mirror_state_from_relations")
	var first: Dictionary = _worldmap.call("_ensure_diplomacy_controller").call("_advance_diplomacy_cooldowns_for_world_turn")
	...
	var second: Dictionary = _worldmap.call("_ensure_diplomacy_controller").call("_advance_diplomacy_cooldowns_for_world_turn")
	...
	var third: Dictionary = _worldmap.call("_ensure_diplomacy_controller").call("_advance_diplomacy_cooldowns_for_world_turn")
...
func _check_trade_agreement_creation_and_renewal() -> void:
	...
	var created: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "trade_agreement", city_id)
	...
	_service.call("set_diplomacy_action_cooldown", _worldmap.call("_ensure_diplomacy_controller"), faction_id, 0)
	relation = _entry(faction_id)
	relation["trade_agreement_turns_remaining"] = maxi(1, duration - 1)
	_store_entry(faction_id, relation)
	var renewed: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "trade_agreement", city_id)
...
func _check_trade_agreement_failure_and_compatibility() -> void:
	...
	var failed: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "trade_agreement", city_id)
	...
	var first_result: bool = _service.call("propose_trade_agreement", _worldmap.call("_ensure_diplomacy_controller"), faction_id)
	var first_state := _state().duplicate(true)
	_worldmap.set("_player_state", before.duplicate(true))
	var repeated_result: bool = _service.call("propose_trade_agreement", _worldmap.call("_ensure_diplomacy_controller"), faction_id)
...
func _check_production_action_parity() -> void:
	...
	var city_id := str(_city_by_faction.get(faction_id, ""))
	var before := _state().duplicate(true)
	var direct: Dictionary = _service.call("execute", _worldmap.call("_ensure_diplomacy_controller"), "trade_agreement", city_id)

...
def main():
    ...
    for file in ["diplomacy_action_service.gd", "spy_action_service.gd", "trade_action_service.gd", "worldmap_action_coordinator.gd"]:
    ...
    assert '["diplomacy", "spy"].has(action_type)' in ui_entry
    ...
    print(f"PASS: spy routing static guard; {len(before)} prior functions retained, legacy body identical, diplomacy/trade/coordinator unchanged")
